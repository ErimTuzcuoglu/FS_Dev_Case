            ...
            'application/json': {
              schema: {
                ...
                items: {
                  type: 'object',
                  properties: {
                    id: {type: 'string', description: 'The user ID.', example: '5f8f8c44b54764421b7156c9'},
                    name: {type: 'string', description: 'The user\'s name.', example: 'John Doe'},
                    email: {type: 'string', description: 'The user\'s email.', example: 'jd@gmail.com'},
                    password: {type: 'string', format: 'date', description: 'The user\'s password.', example: '123'},
                  },
                },
              },
            },
      ...
      parameters: [
        {
          ...
          schema: {type: 'string', example: '5f8f8c44b54764421b7156c9'},
        },
      ],
      responses: {
        ...
        content: {
          'application/json': {
            schema: {
              ...
              properties: {
                email: {type: 'string', description: 'The user\'s email.', example: 'jd@gmail.com'},
                password: {type: 'string', description: 'The user\'s password.', example: '123'},
              },
            },
          },
        },
  ...
  '/api/users/logout/{id}': {
    get: {
      ...
      responses: {
        ...
        400: {description: 'Missing or invalid user ID'},
      },
    },
  },
};
